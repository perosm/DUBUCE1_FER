...
train_x = ds_train.data.reshape([-1, 1, 28, 28]).numpy().astype(np.double) / 255
train_y = ds_train.targets.numpy()
train_x, valid_x = train_x[:55000], train_x[55000:]
train_y, valid_y = train_y[:55000], train_y[55000:]
test_x = ds_test.data.reshape([-1, 1, 28, 28]).numpy().astype(np.double) / 255
...
net += [layers.Convolution(inputs, 16, 5, "conv1")] # izlaz ostaje isti jer padding='same'
